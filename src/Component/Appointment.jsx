...
const Appointment = () => {
  return (
    <div className="bg-teal-500 flex items-center flex-wrap md:px-16 py-10 w-full m-auto ">
      ...
      <div className=" md:w-1/2 w-full text-center md:items-end lg:text-right my-8 px-4">
        <button className='bg-sky-800 text-white px-10 py-3 md:py-3 md:w-96 w-60 mx-auto rounded-xl font-bold md:text-2xl'><Link to='/book-appointment'>Book Now</Link></button>
      </div>
